...
"""
Requirement: Query various information from the order table, such as the number of orders for a certain user, the sales volume of a certain product, the total consumption of a certain user, etc.
"""
